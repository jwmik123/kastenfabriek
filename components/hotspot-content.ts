...
export const DEFAULT_HOTSPOT_CONTENT: HotspotContent = {
  ...
  points: [
    ...
    },
    {
      ...
      body: "Volledig uittrekbare geleiders, dus je komt ook achterin nog bij alles. De fronten krijgen dezelfde kleur of hetzelfde fineer als de rest van de kast, zodat de kastwand één vlak blijft.",
    },
    {
      name: "indeling",
    ...
    {
      name: "afwerking",
      label: "kleur en fineer",
      x: 66,
      y: 31,
      image: "/images/details/frame-33.webp",
      title: "Kleur en fineer tot in de rand",
      body: "Ook de bovenkant, de zijkanten en de randen die je zelden ziet werken we af in dezelfde kleur of hetzelfde fineer. Alle kleuren en fineers liggen op voorraad — bestel gerust eerst een staal.",
