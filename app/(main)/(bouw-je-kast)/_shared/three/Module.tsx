...
import { getLayoutById, computeModulePositions } from '../../kledingkast/scene/moduleLayouts'
...
export default function Module({ index, layoutId, hasDoor, span, diagParams: p }: ModuleProps) {
  ...
  const moduleSlot   = useConfiguratorStore((s) => s.modules.find((m) => m.slotIndex === index))
